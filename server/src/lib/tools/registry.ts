...
// Trading tools (Alpaca integration)
import {
  createGetAccount, GET_ACCOUNT_DESCRIPTION,
  createGetPositions, GET_POSITIONS_DESCRIPTION,
  createPlaceOrder, PLACE_ORDER_DESCRIPTION,
  createCancelOrder, CANCEL_ORDER_DESCRIPTION,
  createGetOrders, GET_ORDERS_DESCRIPTION,
  createClosePosition, CLOSE_POSITION_DESCRIPTION,
  createGetPortfolioHistory, GET_PORTFOLIO_HISTORY_DESCRIPTION,
  createGetTradingConfig, GET_TRADING_CONFIG_DESCRIPTION,
  createUpdateTradingConfig, UPDATE_TRADING_CONFIG_DESCRIPTION,
  createCalculatePosition, CALCULATE_POSITION_DESCRIPTION,
...
export function getToolRegistry(model: string): RegisteredTool[] {
  const tools: RegisteredTool[] = [
    ...
    // Only include if ALPACA_API_KEY is configured
    ...(process.env.ALPACA_API_KEY ? [
      {
        name: 'get_account',
        tool: createGetAccount(),
        description: GET_ACCOUNT_DESCRIPTION,
      },
      {
        name: 'get_positions',
        tool: createGetPositions(),
        description: GET_POSITIONS_DESCRIPTION,
      },
      {
        name: 'place_order',
        tool: createPlaceOrder(),
        description: PLACE_ORDER_DESCRIPTION,
      },
      {
        name: 'cancel_order',
        tool: createCancelOrder(),
        description: CANCEL_ORDER_DESCRIPTION,
      },
      {
        name: 'get_orders',
        tool: createGetOrders(),
        description: GET_ORDERS_DESCRIPTION,
      },
      {
        name: 'close_position',
        tool: createClosePosition(),
        description: CLOSE_POSITION_DESCRIPTION,
      },
      {
        name: 'get_portfolio_history',
        tool: createGetPortfolioHistory(),
        description: GET_PORTFOLIO_HISTORY_DESCRIPTION,
      },
      {
        name: 'get_trading_config',
        tool: createGetTradingConfig(),
        description: GET_TRADING_CONFIG_DESCRIPTION,
      },
      {
        name: 'update_trading_config',
        tool: createUpdateTradingConfig(),
        description: UPDATE_TRADING_CONFIG_DESCRIPTION,
      },
      {
        name: 'calculate_position',
        tool: createCalculatePosition(),
        description: CALCULATE_POSITION_DESCRIPTION,
      },
    ] : []),
  ];
